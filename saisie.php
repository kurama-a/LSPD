						...
						<div class="col-md-12">
							<div class="navbar-collapse collapse ">
								<ul id="menu-top" class="nav navbar-nav navbar-right">
									...
									<li>
										<a href="arrestation.php">Rapports</a>
									</li>
									<li>
										<a href="arrestation.php">Plaintes</a>
									</li>
									<li>
										<a href="arrestation.php">Amendes</a>
									</li>
									<li>
										<a href="arrestation.php">Véhicules saisies</a>
									</li>
									<li>
										<a href="arrestation.php">PPA</a>
									</li>
									<li>
										<a href="arrestation.php">Enquête</a>
									</li>
									<li>
										<a href="arrestation.php">Retrait de licence</a>
									</li>
									<li>
										<a href="arrestation.php">Mise à pied</a>
									</li>
									<li>
										<a href="arrestation.php">Saisie de biens</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="panel-body">
						<form action="add_criminal_post.php" method="post">
							<p>
								...
								<div class="form-group">
									<label for="message">Raison du contrôle</label> :
